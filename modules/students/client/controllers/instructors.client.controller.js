(function () {
  ...
  InstructorsController.$inject = ['$scope', '$state', '$window', 'Authentication', 'instructorResolve'];

  function InstructorsController ($scope, $state, $window, Authentication, instructor) {
    var vm = this;
